...
export SigmaSpeed, SigmaBankO, SigmaBankI, SigmaBankCOC
...
const PenConflict = 3.0
const PenAction = 0.005
const PenCloseness = 10000.0
const PenMinSep = 10000.0
...
const NStates = RangeDim * ThetaDim * Bearingdim * Speeddim^2 * Responsedim + 1
const NActions = 6
#const NActions = 36
...
const SigmaBankO = deg2rad(2.0)  # [rad]
const SigmaBankI = 4*deg2rad(2.0)  # [rad]
